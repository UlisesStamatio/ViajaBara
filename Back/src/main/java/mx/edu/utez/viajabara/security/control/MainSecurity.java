    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers("/api/workshops/**").hasAuthority(PrivilegeName.TALLERES.name())
                        .antMatchers("/api/universities/**").hasAuthority(PrivilegeName.UNIVERSIDADES.name())
                        .antMatchers("/api/inscriptions/**").hasAuthority(PrivilegeName.INSCRIPCIONES.name())
                        .antMatchers("/api/dashboard/**").hasAuthority(PrivilegeName.INSCRIPCIONES.name())
                        .antMatchers("/api/inscriptionsworkshops/**").hasAuthority(PrivilegeName.INSCRIPCIONES.name())
                        .antMatchers("/api/checker/**").permitAll()
