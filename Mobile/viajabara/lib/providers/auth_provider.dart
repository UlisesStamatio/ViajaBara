...
Future<bool> login(String email, String password) async {
    ...
    try {
      final response = await dio.post( 'http://192.168.0.104:8083/api/auth/login', data: dataJson );
  ...
  Future<bool> register(UserData userData) async {
    ...
    try {
      final response = await dio.post('http://192.168.0.104:8083/api/auth/register', data: dataJson);
      print("Si entra aquí");
