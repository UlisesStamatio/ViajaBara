                          ...
                          Card(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Column(children: <Widget>[
                                      const Row(
                                        mainAxisAlignment: MainAxisAlignment.center, // Esto centrará el Row
                                        children: [
                                          Icon(
                                            Icons.person,
                                            color: ColorsApp.primayColor,
                                          ),
                                          SizedBox(width: 8), // Esto añade un espacio entre el icono y el texto
                                          Text('Sexo*')
                                        ],
                                      ),
                                      Row(
                            ...
                            ElevatedButton(
                                onPressed: _isButtonDisabled? null: () async {
                                    ...
                                    bool isRegister = await AuthProvider().register(userData);
