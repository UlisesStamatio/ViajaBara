        ...
        <div class="mt-4 card card-body">
          ...
          <div class="row">
            <div class="col-4">
              ...
              >
                <option value="Choice 1"  selected="">Michael Jackson Smith</option>
                <option value="Choice 2">Paula Rodríguez González</option>
                <option>Selecciona una opción...</option>
              </select>
            </div>
            <div class="col-4">
              <label>Autobus(<span class="text-danger">*</span>)</label>
               <select
                id="choices-bus"
                class="form-control"
                name="choices-bus"
              >
                <option value="Choice 1" selected="">23456789</option>
                <option value="Choice 2">23427789</option>
                <option >Selecciona una opción...</option>
              </select>
            </div>
            <div class="col-4">
              ...
              <select
                ...
                name="choices-route"
              >
                <option value="Choice 1" selected="">Cuernavaca - Jiutepec</option>
                <option value="Choice 2">Alpuyeca - Tres Marías</option>
                <option >Selecciona una opción...</option>
              </select>
            </div>
...
export default {
  ...
  mounted() {
    ...
    if (document.getElementById("choices-route")) {
      let element = document.getElementById("choices-route");
      new Choices(element, {
        searchEnabled: false,
      });
    }

     if (document.getElementById("choices-bus")) {
      let element = document.getElementById("choices-bus");
      new Choices(element, {
        searchEnabled: false,
      });
    }
     ...
     if (document.getElementById("choices-service")) {
      let element = document.getElementById("choices-service");
      new Choices(element, {
        searchEnabled: false,
      });
    }
